...
float grayscale = dot(texture2D(bgl_RenderedTexture, v_textureCoordinates.st), lum);
vec3 rgb = texture2D(bgl_RenderedTexture, v_textureCoordinates.st).rgb;
